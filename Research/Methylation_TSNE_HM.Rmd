...
if (gb$genCNchunk) {
  gb$SaveLoadCnvs(gb$cnData[, 1:(ncol(gb$cnData ))], plotName = "All", plotTitle = "All", isGrp = F)
  if (length(gb$col_samGrp) > 1) {gb$GenCNVdataGroupSave(gb$cnData, targets, gb$col_samGrp)}
} else{
