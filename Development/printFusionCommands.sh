...
msg_code "cd FusionSeq_QC && python3 control_QC_both.py -d '/Volumes/molecular/MOLECULAR LAB ONLY/NYU FUSION SEQer/${currYear} reports' -r ${FSID} -o $HOME/FusionSeq_QC"
