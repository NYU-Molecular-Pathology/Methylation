...
gb$summaryFail <- summaryFail;assign("summaryFail", summaryFail, envir = gb)
```
...
gb$summaryFail <- gb$genSumFail(failedOP, "Positive Control", gb$summaryFail)
```
...
gb$summaryFail <- gb$genSumFail(failedBS, "Bisulfite Conversion", gb$summaryFail)
```
...
gb$summaryFail <- gb$genSumFail(failedHC, "Probe Hybridization", gb$summaryFail)
```
...
gb$summaryFail <- gb$genSumFail(failedDP, "Negative Control", gb$summaryFail)
...
gb <- globalenv(); assign("gb", gb)
gb$MsgFailedQCs(gb$summaryFail)
```
