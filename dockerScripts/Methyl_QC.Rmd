...
<ul>
```{r, post_note, echo=FALSE, results='asis', out.width="70%"}
...
<ul class="scrs">
```{r, post_note2, echo=FALSE, results='asis', out.width="70%"}
...
**Note**: Having a Brain Classifier Score below 0.90 does not indicate the sample failed QC.
</p>

<p style="color:#00008B;font-size:16px;">
Brain classifier output score is not included as part of sample QC. Samples can pass QC and also have no matching Brain tumor classification.
</p>

```{r Summary_notes, echo=FALSE, fig.align="center", message=FALSE, warning=FALSE,include=TRUE, results='asis'}
