...
```{r BioCParallel, echo=FALSE, message=TRUE, warning=FALSE, paged.print=FALSE, results='hide'}
gb <- globalenv(); assign("gb", gb)
...
# MethylAid Summarize ------------------------------------------
sdata <- MethylAid::summarize(fixerrors, verbose = T, batchSize = totNum, force = T, BPPARAM = mcParam)
gb$sdata <- sdata
## Get MU Data & Colors ----------------------------------------
