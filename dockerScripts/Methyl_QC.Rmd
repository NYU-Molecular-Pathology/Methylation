...
---
<style type="text/css">.main-container{margin-left: 25px;}</style>
...
**Note**: Having a Brain Classifier Score below 0.90 does not indicate the sample failed QC.</p>

<p style="color:#00008B;font-size:16px;"> Brain classifier output score is not included as part of sample QC. Samples can pass QC and also have no matching Brain tumor classification.</p>

```{r Summary_notes, echo=FALSE, fig.align="center", fig.width=18, fig.height=12, message=FALSE, warning=FALSE, results="asis", include=TRUE}
library("knitr");library("kableExtra");library("dplyr")
worksheetNam <- file.path(getwd(),paste0(runID,".xlsm"))
