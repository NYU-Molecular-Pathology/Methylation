...
#sdata <- tryCatch(
#    {
#        sdata_temp <- MethylAid::summarize(fixerrors, verbose = TRUE, batchSize = totNum, force = TRUE, BPPARAM = mcParam)
#        return(sdata_temp)
#    },
#    error = function(e) {
#        message(paste("error with biocparallel:\n", e))
#        sdata_temp <- MethylAid::summarize(fixerrors, verbose = TRUE, force = TRUE)
#        return(sdata_temp)
#    }
#)
gb$sdata <- sdata
