...
require("needs")
library("knitr")
optsLi <- list(error = TRUE, echo = FALSE, message = FALSE, warning = FALSE, progress=TRUE, verbose=FALSE, fig.align="left", self.contained=TRUE, comment='', tidy.opts=FALSE, label_list=FALSE, highlight=FALSE, error = TRUE)
...
knitr::opts_chunk$set(error = TRUE, echo = FALSE, message = FALSE, warning = FALSE, self.contained=TRUE, comment = '', progress=TRUE, verbose=FALSE, cache.extra = list(R.version, sessionInfo(), format(Sys.Date(), '%Y-%m')))
options(scipen = 5)
require("compiler")
