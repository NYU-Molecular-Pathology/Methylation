...
require("needs")
library("knitr")
optsLi <- list(error = TRUE, echo = FALSE, message = FALSE, warning = FALSE, progress=FALSE, verbose=FALSE, fig.align="left", self.contained=TRUE, comment='', tidy.opts=FALSE, label_list=FALSE, highlight=FALSE, error = TRUE)

knitr::opts_chunk$set(optsLi)
knitr::opts_knit$set(optsLi)
knitr::opts_current$set(optsLi)
knitr::opts_knit$set(progress=FALSE, verbose=FALSE, error=TRUE)
knitr::opts_knit$set(verbose=FALSE,progress=FALSE,rmarkdown.render.message=FALSE)
knitr::knit(quiet = FALSE)
knitr::knit(progress = FALSE)
...
knitr::opts_chunk$set(error = TRUE, echo = FALSE, message = FALSE, warning = FALSE, self.contained=TRUE, comment = '', progress=FALSE, verbose=FALSE, cache.extra = list(R.version, sessionInfo(), format(Sys.Date(), '%Y-%m')))
options(scipen = 5)
require("compiler")
...
knitr::opts_chunk$set(progress = TRUE, verbose = FALSE, comment='')
knitr::opts_current$set(progress = TRUE, verbose = FALSE, comment='')
