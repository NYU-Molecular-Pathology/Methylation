...
msg_code "conda activate && cd /gpfs/home/${kerbero}/molecpathlab/development/NGS_QC_xf/ && python molecpathlab/development/NGS_QC_xf/xf_pactqc.py -rdir ${molecDir}${runID}/output/ -pactid ${pactRun} && conda deactivate"
echo "$BOX2"
