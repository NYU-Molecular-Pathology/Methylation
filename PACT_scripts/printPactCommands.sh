...
msg_note "NOTE:" "If you have any filler or validation cases that need to be changed in the sample sheet, execute the steps separately."
msg_code "/gpfs/data/molecpathlab/scripts/bash_helpers/make_demux_passed.sh ${runID}"
