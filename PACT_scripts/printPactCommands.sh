...
msg_step 4a "#a980ff" "To complete installation, cd into your bin directory, then close the console to restart it"
...
msg_code "curl -o ${consensusDir}${pactRun}_consensus/${pactRun}_consensus.Rmd -L ${pactGithub}/PACT_consensus.Rmd -s"
