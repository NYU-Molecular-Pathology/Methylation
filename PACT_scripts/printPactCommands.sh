...
msg_step 4 "#d9d2e9" "If you have MiniConda3 skip to step 5, otherwise install it and type \"no\" when prompted if you wish the installer to initialize Miniconda3 by running conda init"
...
msg_step 4a "#d9d2e9" "To complete installation, cd into your bin directory, then close the console to restart it"
