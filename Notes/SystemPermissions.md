...
To prevent any permission issues during install running R:</br> 
Open the MacOS System Preferences app by pressing **⌘(CMD) + Space** and searching "System Pref"<br>
In the System Preferences app click on Security & Privacy:<br>
...
#### 1. Click on the "General" Tab and click the lock to make changes</br>
