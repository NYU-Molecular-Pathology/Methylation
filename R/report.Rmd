---
title: "Methylation Profiling Report Version 1.2"
author: "Quick Links:"
output: 
  html_document: 
    self_contained: yes
...
if(all(RGset@assays@data@listData[["Green"]]==0)){
  cat("\n\n")
  cat("Array Values are not valid!  All are NaN.  This array may be incompatible with the Current Classifer!")
  cat("\n\n")
  knitr::knit_exit()
}
```
